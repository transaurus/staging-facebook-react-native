...
If you get a "bridge configuration isn't available" error, see [Using adb reverse](/zh-Hans/docs/running-on-device.md#method-1-using-adb-reverse-recommended).
...
You can now enable Fast Refresh from the [Dev Menu](/zh-Hans/docs/debugging.md#opening-the-dev-menu). Your app will reload whenever your JavaScript code has changed.
...
3. You'll see a [red screen with an error](/zh-Hans/docs/debugging.md#logbox). This is OK. The following steps will fix that.
4. Open the in-app [Dev Menu](/zh-Hans/docs/debugging.md#opening-the-dev-menu).
...
![](/zh-Hans/assets/images/RunningOnDeviceCodeSigning-daffe4c45a59c3f5031b35f6b24def1d.png)
...
You can also iterate quickly on a device using the development server. You only have to be on the same Wi-Fi network as your computer. Shake your device to open the [Dev Menu](/zh-Hans/docs/debugging.md#opening-the-dev-menu), then enable Fast Refresh. Your app will reload whenever your JavaScript code has changed.

![](/zh-Hans/assets/images/debugging-dev-menu-083-70616da2986550a977feb0158f218bdd.jpg)
...
When trying to connect to the development server you might get a [red screen with an error](/zh-Hans/docs/debugging.md#logbox) saying:
...
![](/zh-Hans/assets/images/XcodeBuildIP-dfc8243436f5436466109acb8f9e0502.png)
...
You have built a great app using React Native, and you are now itching to release it in the App Store. The process is the same as any other native iOS app, with some additional considerations to take into account. Follow the guide for [publishing to the Apple App Store](/zh-Hans/docs/publishing-to-app-store.md) to learn more.

info

A Mac is required in order to build your app for iOS devices. Alternatively, you can refer to our [environment setup guide](/zh-Hans/docs/environment-setup.md) to learn how to build your app using Expo CLI, which will allow you to run your app using the Expo client app.
