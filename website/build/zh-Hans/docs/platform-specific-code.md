...
* Using the [`Platform` module](/zh-Hans/docs/platform-specific-code.md#platform-module).
* Using [platform-specific file extensions](/zh-Hans/docs/platform-specific-code.md#platform-specific-extensions).
