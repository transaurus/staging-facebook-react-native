...
If you have constraints that are not served well by a [Framework](/zh-Hans/architecture/glossary.md#react-native-framework), or you prefer to write your own Framework, you can create a React Native app without using a Framework.

To do so, you'll first need to [set up your environment](/zh-Hans/docs/set-up-your-environment.md). Once you're set up, continue with the steps below to create an application and start developing.
...
If you can't get this to work, see the [Troubleshooting](/zh-Hans/docs/troubleshooting.md) page.
