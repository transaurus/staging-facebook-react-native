...
Right now the process of creating a React Native platform from scratch is not very well documented - one of the goals of the upcoming re-architecture ([Fabric](/zh-Hans/blog/2018/06/14/state-of-react-native-2018.md)) is to make maintaining a platform easier.
