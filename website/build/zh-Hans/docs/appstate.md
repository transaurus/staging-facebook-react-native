...
This event is received when the app state has changed. The listener is called with one of [the current app state values](/zh-Hans/docs/appstate.md#app-states).
