...
The `DropShadowValue` object is taken by the [`filter`](/zh-Hans/docs/view-style-props.md#filter) style prop for the `dropShadow` function. It is comprised of 2 or 3 lengths and an optional color. These values collectively define the drop shadow's color, position, and blurriness.
...
* [`filter`](/zh-Hans/docs/view-style-props.md#filter)
