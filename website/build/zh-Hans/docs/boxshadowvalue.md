...
The `BoxShadowValue` object is taken by the [`boxShadow`](/zh-Hans/docs/view-style-props.md#boxshadow) style prop. It is comprised of 2-4 lengths, an optional color, and an optional `inset` boolean. These values collectively define the box shadow's color, position, size, and blurriness.
...
| Type                             | Optional |
| -------------------------------- | -------- |
| [color](/zh-Hans/docs/colors.md) | Yes      |
...
* [`boxShadow`](/zh-Hans/docs/view-style-props.md#boxshadow)
