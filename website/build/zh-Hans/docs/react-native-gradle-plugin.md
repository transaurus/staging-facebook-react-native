...
If you're integrating React Native into an existing project, please refer to [the corresponding page](/zh-Hans/docs/next/integration-with-existing-apps#configuring-gradle): it contains specific instructions on how to install the plugin.
