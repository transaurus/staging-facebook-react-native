...
This page covers how to use legacy JavaScript debugging methods. If you are getting started with a new React Native or Expo app, we recommend using [React Native DevTools](/zh-Hans/docs/react-native-devtools.md).
...
![Opening Safari Web Inspector](/zh-Hans/assets/images/debugging-safari-developer-tools-5aefdee28e230260908d691621c4fa63.jpg)
...
If you are on an older version of React Native, please go to the docs [for your version](/zh-Hans/versions.md).

![The remote debugger window in Chrome](/zh-Hans/assets/images/debugging-chrome-remote-debugger-ddf0ea5593f18b93a26ed3a8ea44e42e.jpg)
