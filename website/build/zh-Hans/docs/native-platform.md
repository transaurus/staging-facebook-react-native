...
* [Legacy Native Modules](/zh-Hans/docs/legacy/native-modules-intro.md);
* [Legacy Native Components](/zh-Hans/docs/legacy/native-components-android.md);
...
1. Native Modules
   ...
   * [Android & iOS](/zh-Hans/docs/turbo-native-modules-introduction.md)
   * [Cross-Platform with C++](/zh-Hans/docs/the-new-architecture/pure-cxx-modules.md)
   * [Advanced: Custom C++ Types](/zh-Hans/docs/the-new-architecture/custom-cxx-types.md)

2. Fabric Native Components
   <!-- -->
   * [Android & iOS](/zh-Hans/docs/fabric-native-components-introduction.md)
