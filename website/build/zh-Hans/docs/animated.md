...
Refer to the [Animations](/zh-Hans/docs/animations.md#animated-api) guide to see additional examples of `Animated` in action.

## Overview[​](#overview "Direct link to Overview")

There are two value types you can use with `Animated`:

* [`Animated.Value()`](/zh-Hans/docs/animated.md#value) for single values
* [`Animated.ValueXY()`](/zh-Hans/docs/animated.md#valuexy) for vectors
...
* [`Animated.decay()`](/zh-Hans/docs/animated.md#decay) starts with an initial velocity and gradually slows to a stop.
* [`Animated.spring()`](/zh-Hans/docs/animated.md#spring) provides a basic spring physics model.
* [`Animated.timing()`](/zh-Hans/docs/animated.md#timing) animates a value over time using [easing functions](/zh-Hans/docs/easing.md).
...
You can use the native driver by specifying `useNativeDriver: true` in your animation configuration. See the [Animations](/zh-Hans/docs/animations.md#using-the-native-driver) guide to learn more.
...
* [`createAnimatedComponent()`](/zh-Hans/docs/animated.md#createanimatedcomponent) can be used to make a component animatable.
...
* [`Animated.delay()`](/zh-Hans/docs/animated.md#delay) starts an animation after a given delay.
* [`Animated.parallel()`](/zh-Hans/docs/animated.md#parallel) starts a number of animations at the same time.
* [`Animated.sequence()`](/zh-Hans/docs/animated.md#sequence) starts the animations in order, waiting for each to complete before starting the next.
* [`Animated.stagger()`](/zh-Hans/docs/animated.md#stagger) starts animations in order and in parallel, but with successive delays.

Animations can also be chained together by setting the `toValue` of one animation to be another `Animated.Value`. See [Tracking dynamic values](/zh-Hans/docs/animations.md#tracking-dynamic-values) in the Animations guide.
...
* [`Animated.add()`](/zh-Hans/docs/animated.md#add)
* [`Animated.subtract()`](/zh-Hans/docs/animated.md#subtract)
* [`Animated.divide()`](/zh-Hans/docs/animated.md#divide)
* [`Animated.modulo()`](/zh-Hans/docs/animated.md#modulo)
* [`Animated.multiply()`](/zh-Hans/docs/animated.md#multiply)

### Interpolation[​](#interpolation "Direct link to Interpolation")

The `interpolate()` function allows input ranges to map to different output ranges. By default, it will extrapolate the curve beyond the ranges given, but you can also have it clamp the output value. It uses linear interpolation by default but also supports easing functions.

* [`interpolate()`](/zh-Hans/docs/animatedvalue.md#interpolate)

Read more about interpolation in the [Animation](/zh-Hans/docs/animations.md#interpolation) guide.
...
* [`Animated.event()`](/zh-Hans/docs/animated.md#event)
...
Animates a value along a timed easing curve. The [`Easing`](/zh-Hans/docs/easing.md) module has tons of predefined curves, or you can use your own function.
...
You can read more about `Animated.Value` API on the separate [page](/zh-Hans/docs/animatedvalue.md).
...
You can read more about `Animated.ValueXY` API on the separate [page](/zh-Hans/docs/animatedvaluexy.md).
