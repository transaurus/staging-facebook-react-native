...
`PressEvent` object is returned in the callback as a result of user press interaction, for example `onPress` in [Button](/zh-Hans/docs/button.md) component.
...
* [`Button`](/zh-Hans/docs/button.md)
* [`PanResponder`](/zh-Hans/docs/panresponder.md)
...
* [`TouchableHighlight`](/zh-Hans/docs/touchablenativefeedback.md)
* [`TouchableOpacity`](/zh-Hans/docs/touchablewithoutfeedback.md)
* [`TouchableNativeFeedback`](/zh-Hans/docs/touchablenativefeedback.md)
