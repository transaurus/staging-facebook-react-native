...
* [Set up your environment](/zh-Hans/docs/environment-setup.md)
* [Set up your development workflow](/zh-Hans/docs/running-on-device.md)
* [Design and layout your app](/zh-Hans/docs/flexbox.md)
* [Debug your app](/zh-Hans/docs/debugging.md)
* [Make your app cross platform](/zh-Hans/docs/platform-specific-code.md)
* [Get involved in the React Native community](/zh-Hans/community/overview.md)
...
Interested in making your own Native Component or Module? Making modules for your own use case and sharing them with others on NPM and GitHub helps grow the React Native ecosystem and community! Read the guides to making your own Native Modules ([Android](/zh-Hans/docs/legacy/native-modules-android.md), [iOS](/zh-Hans/docs/legacy/native-modules-ios.md)) and Native Components ([Android](/zh-Hans/docs/legacy/native-components-android.md), [iOS](/zh-Hans/docs/legacy/native-components-ios.md)).
