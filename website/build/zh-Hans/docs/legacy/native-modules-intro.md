...
1. Creating a local library that can be imported in your React Native application. Read [Creating local libraries](/zh-Hans/docs/legacy/local-library-setup.md) guide to learn more.
...
This guide will first walk you through implementing a native module directly within a React Native application. However the native module you build in the following guide can be distributed as an NPM package. Check out the [Setting Up a Native Module as an NPM Package](/zh-Hans/docs/legacy/native-modules-setup.md) guide if you are interested in doing so.

## Getting Started[​](#getting-started "Direct link to Getting Started")

In the following sections we will walk you through guides on how to build a native module directly within a React Native application. As a prerequisite, you will need a React Native application to work within. You can follow the steps [here](/zh-Hans/docs/getting-started.md) to setup a React Native application if you do not already have one.
...
In the following sections you will create such a Calendar native module for both [Android](/zh-Hans/docs/legacy/native-modules-android.md) and [iOS](/zh-Hans/docs/legacy/native-modules-ios.md).
