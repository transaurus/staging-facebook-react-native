...
When all steps above are done, you will be able to continue with [Android Native Modules](/zh-Hans/docs/legacy/native-modules-android.md) or [iOS Native Modules](/zh-Hans/docs/legacy/native-modules-ios.md) guides to add in some code.
