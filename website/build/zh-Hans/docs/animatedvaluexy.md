...
2D Value for driving 2D animations, such as pan gestures. Almost identical API to normal [`Animated.Value`](/zh-Hans/docs/animatedvalue.md), but multiplexed. Contains two regular `Animated.Value`s under the hood.
