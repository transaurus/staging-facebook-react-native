...
Follow the guide on [setting up your development environment](/zh-Hans/docs/set-up-your-environment.md) and using [React Native without a framework](/zh-Hans/docs/getting-started-without-a-framework.md) to configure your development environment for building React Native apps for Android. This guide also assumes you're familiar with the basics of Android development such as creating Activities and editing the `AndroidManifest.xml` file.
...
At this point you can continue developing your app as usual. Refer to our [debugging](/zh-Hans/docs/debugging.md) and [deployment](/zh-Hans/docs/running-on-device.md) docs to learn more about working with React Native.
...
![Disable Sandboxing](/zh-Hans/assets/images/disable-sandboxing-6948d9cf1b719f09d30946b97bb68771.png)

Finally, make sure to add the `UIViewControllerBasedStatusBarAppearance` key into your `Info.plist` file, with value of `NO`.

![Disable UIViewControllerBasedStatusBarAppearance](/zh-Hans/assets/images/disable-UIViewControllerBasedStatusBarAppearance-c778c3d65569a165bf2b76c43438af71.png)
