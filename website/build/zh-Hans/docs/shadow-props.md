...
* `dropShadow`: A specific filter function available as part of the [`filter`](/zh-Hans/docs/view-style-props.md#filter) View style prop.
...
See [View Style Props](/zh-Hans/docs/view-style-props.md#boxshadow) for documentation.

### `dropShadow`Android[​](#dropshadow-android "Direct link to dropshadow-android")

See [View Style Props](/zh-Hans/docs/view-style-props.md#filter) for documentation.

### `shadowColor`[​](#shadowcolor "Direct link to shadowcolor")

Sets the drop shadow color.

This property will only work on Android API 28 and above. For similar functionality on lower Android APIs, use the [`elevation` property](/zh-Hans/docs/view-style-props.md#elevation-android).
