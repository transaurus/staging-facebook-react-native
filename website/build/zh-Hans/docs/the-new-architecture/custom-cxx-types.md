...
This guide assumes that you are familiar with the [**Pure C++ Turbo Native Modules**](/zh-Hans/docs/the-new-architecture/pure-cxx-modules.md) guide. This will build on top of that guide.
