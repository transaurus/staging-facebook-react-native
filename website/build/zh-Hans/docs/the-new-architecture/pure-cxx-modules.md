...
The next step is to configure [Codegen](/zh-Hans/docs/the-new-architecture/what-is-codegen.md) in your `package.json`. Update the file to include:
...
![Add Files to Sample App...](/zh-Hans/assets/images/AddFilesToXcode1-801bbeb4251cda02929c1863939466c5.png)

3. Select the `shared` folder and click on `Add`.

![Add Files to Sample App...](/zh-Hans/assets/images/AddFilesToXcode2-f22d79daca6d0e121ad57c63225e43c6.png)

If you did everything right, your project on the left should look like this:

![Xcode Project](/zh-Hans/assets/images/CxxTMGuideXcodeProject-96458e4d285dbdde12b12edaf7193e57.png)
