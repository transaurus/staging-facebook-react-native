...
The guide for [Integration with Existing Apps](/zh-Hans/docs/integration-with-existing-apps.md) details how to integrate a full-screen React Native app into an existing Android app as an **Activity**.
...
Follow the guide for [Integration with Existing Apps](/zh-Hans/docs/integration-with-existing-apps.md) until the end to make sure you can safely run your React Native app in a full screen Activity.
...
![Screenshot](/zh-Hans/assets/images/EmbeddedAppAndroidFragmentVideo-aab979735a01abb7c006e01a4442d20c.gif)
