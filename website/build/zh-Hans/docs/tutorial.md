...
With `props` and the basic [`Text`](/zh-Hans/docs/text.md), [`Image`](/zh-Hans/docs/image.md), and [`View`](/zh-Hans/docs/view.md) components, you can build a wide variety of static screens. To learn how to make your app change over time, you need to [learn about State](#state).
