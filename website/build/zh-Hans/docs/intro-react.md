...
Here is how you do it: To define your `Cat` component, first use JavaScript’s [`import`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/import) to import React and React Native’s [`Text`](/zh-Hans/docs/next/text) Core Component:
...
You’ve already met [React Native’s Core Components](/zh-Hans/docs/intro-react-native-components.md). React lets you nest these components inside each other to create new components. These nestable, reusable components are at the heart of the React paradigm.

For example, you can nest [`Text`](/zh-Hans/docs/text.md) and [`TextInput`](/zh-Hans/docs/textinput.md) inside a [`View`](/zh-Hans/docs/view.md) below, and React Native will render them together:
...
On Android, you usually put your views inside `LinearLayout`, `FrameLayout`, `RelativeLayout`, etc. to define how the view’s children will be arranged on the screen. In React Native, `View` uses Flexbox for its children’s layout. You can learn more in [our guide to layout with Flexbox](/zh-Hans/docs/flexbox.md).
...
Most of React Native’s Core Components can be customized with props, too. For example, when using [`Image`](/zh-Hans/docs/image.md), you pass it a prop named [`source`](/zh-Hans/docs/image.md#source) to define what image it shows:

`Image` has [many different props](/zh-Hans/docs/image.md#props), including [`style`](/zh-Hans/docs/image.md#style), which accepts a JS object of design and layout related property-value pairs.
...
You can build many things with props and the Core Components [`Text`](/zh-Hans/docs/text.md), [`Image`](/zh-Hans/docs/image.md), and [`View`](/zh-Hans/docs/view.md)! But to build something interactive, you’ll need state.
...
Next you add the [`Button`](/zh-Hans/docs/button.md) Core Component and give it an `onPress` prop:
...
Now that you’ve covered both React and React Native’s Core Components, let’s dive deeper on some of these core components by looking at [handling `<TextInput>`](/zh-Hans/docs/handling-text-input.md).
