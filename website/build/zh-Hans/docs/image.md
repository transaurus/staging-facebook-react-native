...
| Type                                              |
| ------------------------------------------------- |
| [ImageSource](/zh-Hans/docs/image.md#imagesource) |
...
| Type                                                                   |
| ---------------------------------------------------------------------- |
| [ImageSource](/zh-Hans/docs/image.md#imagesource) (`uri` only), number |
...
This prop can also contain several remote URLs, specified together with their width and height and potentially with scale/other URI arguments. The native side will then choose the best `uri` to display based on the measured size of the image container. A `cache` property can be added to control how networked request interacts with the local cache. (For more information see [Cache Control for Images](/zh-Hans/docs/images.md#cache-control)).
...
| Type                                                                                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Image Style Props](/zh-Hans/docs/image-style-props.md#props), [Layout Props](/zh-Hans/docs/layout-props.md#props), [Shadow Props](/zh-Hans/docs/shadow-props.md#props), [Transforms](/zh-Hans/docs/transforms.md#props) |
...
| Name           | Type                                                      | Description                                                                  |
| -------------- | --------------------------------------------------------- | ---------------------------------------------------------------------------- |
| sourceRequired | [ImageSource](/zh-Hans/docs/image.md#imagesource), number | A number (opaque type returned by `require('./foo.png')`) or an ImageSource. |
...
| cacheiOS  | [ImageCacheEnum](/zh-Hans/docs/image.md#imagecacheenum-ios) | Determines how the requests handles potentially cached responses.                                                                                                                    |
