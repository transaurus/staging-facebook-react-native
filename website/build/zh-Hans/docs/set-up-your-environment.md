...
Setting up your environment is not required if you're using a [Framework](/zh-Hans/architecture/glossary.md#react-native-framework). With a React Native Framework, you don't need to set up Android Studio or Xcode as it will take care of building the native app for you

If you have constraints that prevent you from using a Framework, or you'd like to write your own Framework, then setting up your local environment is a requirement. After your environment is set up, learn how to [get started without a framework](/zh-Hans/docs/getting-started-without-a-framework.md).
...
![Android Studio Welcome](/zh-Hans/assets/images/GettingStartedAndroidStudioWelcomeMacOS-8af2dfd190d6acc795d58c7f89197dcd.png)
...
If you have a physical Android device, you can use it for development in place of an AVD by plugging it in to your computer using a USB cable and following the instructions [here](/zh-Hans/docs/running-on-device.md).
...
* If you want to add this new React Native code to an existing application, check out the [Integration guide](/zh-Hans/docs/integration-with-existing-apps.md).
* If you're curious to learn more about React Native, check out the [Introduction to React Native](/zh-Hans/docs/getting-started.md).
...
![Xcode Command Line Tools](/zh-Hans/assets/images/GettingStartedXcodeCommandLineTools-a319295928960a4458698528086e3230.png)
...
![Android Studio Welcome](/zh-Hans/assets/images/GettingStartedAndroidStudioWelcomeWindows-8a34e703bcb79bb67f84764b04f3e05c.png)
...
A Mac is required to build projects with native code for iOS. You can use [Expo Go](https://expo.dev/go) from [Expo](/zh-Hans/docs/environment-setup.md#start-a-new-react-native-project-with-expo) to develop your app on your iOS device.
