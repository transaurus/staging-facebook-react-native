...
[![Alex Tait](https://github.com/alextait1.png)](https://twitter.com/AT_Fresh_Dev)

[Alex Tait](https://twitter.com/AT_Fresh_Dev)

React Native Accessibility Community Manager

May 19th, 2022 marks the 11th annual celebration of Global Accessibility Awareness Day and we wanted to update everyone on the accessibility progress we’ve made on the React Native Framework. Meta (formerly Facebook) was the [first organization to take the GAAD pledge in 2020](/zh-Hans/blog/2021/03/08/GAAD-React-Native-Accessibility.md), committing to making the React Native framework accessible.
...
## Fixes that have already landed in 2022[​](#fixes-that-have-already-landed-in-2022 "Direct link to Fixes that have already landed in 2022")
...
## Fixes currently in progress[​](#fixes-currently-in-progress "Direct link to Fixes currently in progress")
...
## Contributor highlight[​](#contributor-highlight "Direct link to Contributor highlight")
...
## What’s next in 2022[​](#whats-next-in-2022 "Direct link to What’s next in 2022")
