...
* [React 18](/zh-Hans/blog/2022/06/21/version-069.md#react-18)
* [Bundled Hermes](/zh-Hans/blog/2022/06/21/version-069.md#bundled-hermes)
* [Highlights of 0.69](/zh-Hans/blog/2022/06/21/version-069.md#highlights-of-069)
...
Using the proper version of Hermes is handled by React Native, however, make sure to follow the steps in the [upgrade helper](https://react-native-community.github.io/upgrade-helper/?from=0.68.2\&to=0.69.0) to ensure the integration works as intended. If you don't have Hermes enabled already, you can follow the steps [here](/zh-Hans/docs/hermes.md) to do so. While we will continue supporting other JavaScript engines, we recommend everyone to migrate to Hermes to have the best experience and to make sure we can support you better.

Note that users on the New Architecture on Android will need to **build Hermes from source**. For building Hermes from source, Windows users will need to additionally follow [these steps](/zh-Hans/architecture/bundled-hermes.md#android-users-on-new-architecture-building-on-windows).

If you are interested to learn more about how React Native bundles Hermes works under the hood, you can check out the deep-dive documentation [here](/zh-Hans/architecture/bundled-hermes.md).

## New Architecture[​](#new-architecture "Direct link to New Architecture")

We are continuing the roll-out of the New Architecture for both Android and iOS. If you have not migrated your app or library, yet, follow the steps [here](https://github.com/reactwg/react-native-new-architecture#guides). You can also read the [latest update](/zh-Hans/blog/2022/06/16/resources-migrating-your-react-native-library-to-the-new-architecture.md) on tools and resources for the New Architecture to learn more.
