...
[](https://x.com/vincentriemer "X")[](https://github.com/vincentriemer "GitHub")
...
### Going Beyond Touch[​](#going-beyond-touch "Direct link to Going Beyond Touch")
...
### Looking to Web[​](#looking-to-web "Direct link to Looking to Web")
...
## Porting Web Platform Tests[​](#porting-web-platform-tests "Direct link to Porting Web Platform Tests")
...
![GIF showing a side by side comparison of the \&quot;Pointer Events hoverable pointer attributes test\&quot; running in React Native (iOS) on the left, and Web (the original implementation) on the right.](/zh-Hans/assets/images/pointer-events-wpt-demo-b6012cf8f27dbaa8a62da5731447ae61.gif)
...
![Diagram of code flow for interpreting Android and iOS UI input events into Pointer Events. On Android, input handlers \&quot;onTouchEvent\&quot; and \&quot;onHoverEvent\&quot; fire \&quot;MotionEvents\&quot; that are interpreted into Pointer Events and through JSI are dispatched to the React renderer. iOS takes a similar path with input handlers \&quot;touchesBegan\&quot;, \&quot;touchesMoved\&quot;, \&quot;touchesEnded\&quot;, and \&quot;hovering\&quot; interpreting \&quot;UITouch\&quot; and \&quot;UIEvent\&quot; into Pointer Events.](/zh-Hans/assets/images/pointer-events-code-flow-bace513aed36f46ece1e60ebf46efd4a.png)
...
![A diagram illustrating the relationship of types of Android MotionEvents into Pointer Events fired. Some pointer events are conditionally fired if pointing device does not support hover. \&quot;ACTION\_DOWN\&quot; and \&quot;ACTION\_POINTER\_DOWN\&quot; fire pointerdown and conditionally fire pointerenter, pointerover. \&quot;ACTION\_MOVE\&quot; and \&quot;ACTION\_HOVER\_MOVE\&quot; fire pointerover, pointermove, pointerout, pointerup. \&quot;ACTION\_UP\&quot; and \&quot;ACTION\_POINTER\_UP\&quot; fire pointerup and conditionally fire pointerout, pointerleave.](/zh-Hans/assets/images/pointer-events-motionevent-relationship-7b1d579ae729223e3632aaf41a7f4991.png)
...
## Implementation Progress[​](#implementation-progress "Direct link to Implementation Progress")
...
### Event Properties[​](#event-properties "Direct link to Event Properties")
...
## Future Work and Exploration[​](#future-work-and-exploration "Direct link to Future Work and Exploration")
...
### Enable Feature Flags[​](#enable-feature-flags "Direct link to Enable Feature Flags")
...
### iOS-specific[​](#ios-specific "Direct link to iOS-specific")
...
### Android-specific[​](#android-specific "Direct link to Android-specific")
...
## Feedback Welcome[​](#feedback-welcome "Direct link to Feedback Welcome")
