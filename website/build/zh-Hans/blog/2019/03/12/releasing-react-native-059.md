...
![source of the metro.config.js file in the 0.59 template, demonstrating where to enable inlineRequires](/zh-Hans/assets/images/inline-requires-3cb1be96938288642a666bdf3dca62b5.png)

We need the community to let us know how it works before we turn it on by default. When you upgrade to 0.59, there will be a new `metro.config.js` file; flip the options to true and give us [your feedback](https://twitter.com/hashtag/inline-requires)! Read more about inline requires [in the performance docs](/zh-Hans/docs/performance.md#inline-requires) to benchmark your app.
...
![0.58\&#39;s CLI is slow to start](/zh-Hans/assets/images/0.58-cli-speed-99311dbeb7f554d4beadd5960d82be74.png)![0.58\&#39;s CLI is nearly instantaneous](/zh-Hans/assets/images/0.59-cli-speed-792273d28963a86e24e22ccfb69f1a99.png)
