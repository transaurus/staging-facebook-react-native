...
[](/img/homepage/DoctorCommand.mp4)
...
![Doctor command with a link to help on Android SDK's installation](/img/DoctorManualInstallationMessage.png "Doctor command with a link to help on Android SDK's installation")
...
## What checks are currently supported[​](#what-checks-are-currently-supported "Direct link to What checks are currently supported")
