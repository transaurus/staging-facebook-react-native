...
* [Hermes on iOS](/zh-Hans/blog/2021/03/12/version-0.64.md) now [supports Apple M1 Macs and Mac Catalyst](https://github.com/facebook/hermes/pull/546)!
...
[Follow steps here](/zh-Hans/docs/hermes.md#enabling-hermes) to opt-in your app to Hermes if you haven’t already to leverage these new features and gains!
...
* Allow specification of high contrast light and dark values for iOS. See [documentation](/zh-Hans/docs/dynamiccolorios.md) for more details.
* Added [`getRecommendedTimeoutMillis`](/zh-Hans/docs/accessibilityinfo.md#getrecommendedtimeoutmillis-android) API on Android. This exposes a user’s preferred default timeout value as set in Android’s accessibility options and is for users who may need extra time to review or reach controls, etc.
