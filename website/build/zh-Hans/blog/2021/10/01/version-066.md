...
* [Handle taps on views outside parent bounds on Android](/zh-Hans/blog/2021/10/01/version-066.md#handle-taps-on-child-views-outside-parent-boundaries-on-android)
* [New Bluetooth Permissions on Android](/zh-Hans/blog/2021/10/01/version-066.md#new-bluetooth-permissions-on-android)
* [Better Support for Apple Silicon, Xcode 13, and iOS 15](/zh-Hans/blog/2021/10/01/version-066.md#better-support-for-apple-silicon-xcode-13-and-ios-15)
* [Hermes 0.9.0](/zh-Hans/blog/2021/10/01/version-066.md#hermes-090)
* [Nightly and “Commitly” Releases](/zh-Hans/blog/2021/10/01/version-066.md#nightly-and-commitly-releases)

### Handle taps on child views outside parent boundaries on Android[​](#handle-taps-on-child-views-outside-parent-boundaries-on-android "Direct link to Handle taps on child views outside parent boundaries on Android")
...
### New Bluetooth Permissions on Android[​](#new-bluetooth-permissions-on-android "Direct link to New Bluetooth Permissions on Android")
...
### Better Support for Apple Silicon, Xcode 13, and iOS 15[​](#better-support-for-apple-silicon-xcode-13-and-ios-15 "Direct link to Better Support for Apple Silicon, Xcode 13, and iOS 15")
...
Check out this [post](/zh-Hans/blog/2021/09/01/preparing-your-app-for-iOS-15-and-android-12.md) we shared on preparing your app for iOS 15 and Android 12.

### Hermes 0.9.0[​](#hermes-090 "Direct link to Hermes 0.9.0")
...
### Nightly and “Commitly” Releases[​](#nightly-and-commitly-releases "Direct link to Nightly and “Commitly” Releases")

In a [recent blog post](/zh-Hans/blog/2021/08/19/h2-2021.md) we shared that one of our goals in the second half of 2021 is to improve our release process to be faster and more stable. As part of this effort we are working to make React Native more stable on main and to reduce the bugs identified during our Release Candidate process.
...
#### Using Nightly Releases (Nightlies)[​](#using-nightly-releases-nightlies "Direct link to Using Nightly Releases (Nightlies)")
...
#### Using Commitly Releases (Commitlies)[​](#using-commitly-releases-commitlies "Direct link to Using Commitly Releases (Commitlies)")

![Screenshot of CircleCI artifact panel to find tarball](/blog/assets/0.66-artifact.png)

Find the "build\_npm\_package-1" job related to a commit and head to the "Artifacts" panel to download the tarball for the commitly.
