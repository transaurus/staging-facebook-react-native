...
## Closed Pull Requests 🎉[​](#closed-pull-requests- "Direct link to Closed Pull Requests 🎉")
...
* [feat: set disabled accessibilityState when TouchableHighlight is disabled #31135](https://github.com/facebook/react-native/pull/31135) closed by [@natural\_clar](https://twitter.com/natural_clar)
...
## Other Progress[​](#other-progress "Direct link to Other Progress")
