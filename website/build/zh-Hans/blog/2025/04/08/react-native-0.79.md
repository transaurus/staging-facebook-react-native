...
* [New Metro Features](/zh-Hans/blog/2025/04/08/react-native-0.79.md#metro-faster-startup-and-package-exports-support)
* [JSC moving to a Community Package](/zh-Hans/blog/2025/04/08/react-native-0.79.md#jsc-moving-to-community-package)
* [iOS: Swift-Compatible Native Modules registration](/zh-Hans/blog/2025/04/08/react-native-0.79.md#ios-swift-compatible-native-modules-registration)
* [Android: Faster App Startup](/zh-Hans/blog/2025/04/08/react-native-0.79.md#android-faster-app-startup)
* [Removal of Remote JS Debugging](/zh-Hans/blog/2025/04/08/react-native-0.79.md#removal-of-remote-js-debugging)
...
![metro startup comparison](/zh-Hans/assets/images/0.79-metro-startup-comparison-6dd153aeb4b43cb5dec1390b67bc4673.gif)

Also in Metro 0.82, we’re promoting `package.json` `"exports"` and `"imports"` field resolution to stable. `"exports"` resolution was [introduced in React Native 0.72](/zh-Hans/blog/2023/06/21/package-exports-support.md), and `"imports"` support was added in a community contribution - both will now be enabled by default for all the projects on React Native 0.79.
...
In this release, we are revamping the way in which you can register your Native Module into the React Native runtime. The new approach follows the same approach of components, described in the [official documentation](/zh-Hans/docs/next/the-new-architecture/using-codegen#configuring-codegen).
...
As part of our ongoing efforts to improve debugging, we're removing Remote JS Debugging via Chrome. This legacy debugging method was deprecated, [and moved to a runtime opt-in, in React Native 0.73](/zh-Hans/blog/2023/12/06/0.73-debugging-improvements-stable-symlinks.md#remote-javascript-debugging). Please use [React Native DevTools](/zh-Hans/docs/react-native-devtools.md) for modern and reliable debugging.
