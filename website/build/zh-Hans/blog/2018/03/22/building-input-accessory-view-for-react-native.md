...
In the ensuing years, there have been countless '+1s', various workarounds, and zero concrete changes to RN on this issue - until today. Starting with iOS, [we're exposing an API](/zh-Hans/docs/inputaccessoryview.md) for accessing the native input accessory view and we are excited to share how we built it.
...
The full commit for this feature implementation is [here](https://github.com/facebook/react-native/commit/38197c8230657d567170cdaf8ff4bbb4aee732b8). [`<InputAccessoryView>`](/zh-Hans/docs/next/inputaccessoryview) will be available in the upcoming v0.55.0 release.
