...
[](https://x.com/Eli_White "X")[](https://github.com/elicwhite "GitHub")

Twitter’s iOS app has a loading animation I quite enjoy.

![](/blog/assets/loading-screen-01.gif)
...
![](/blog/assets/loading-screen-02.gif)
...
## The right way[​](#the-right-way "Direct link to The right way")
...
![](/blog/assets/loading-screen-03.png)
...
![](/blog/assets/loading-screen-04.png)
...
[Loading Screen Animation Steps](//codepen.io/TheSavior/embed/NXNoJM/?height=265\&theme-id=0\&default-tab=result\&embed-version=2)

## Now, for the React Native[​](#now-for-the-react-native "Direct link to Now, for the React Native")
...
## Now for the Animated part[​](#now-for-the-animated-part "Direct link to Now for the Animated part")

We have all the pieces we need to make this work, the next step is animating them. To make this animation feel good, we will be utilizing React Native’s [Animated](/zh-Hans/docs/animated.md) API.
...
Since we want this animation to be smooth, we will work within these constraints. For a more in depth look at how `useNativeDriver` works under the hood, check out our [blog post announcing it](/zh-Hans/blog/2017/02/14/using-native-driver-for-animated.md).

## Breaking down our animation[​](#breaking-down-our-animation "Direct link to Breaking down our animation")
...
![](/zh-Hans/assets/images/loading-screen-05-9b5c5f9b785287a11b6444ad4a8afcad.png)
...
## And now, in code.[​](#and-now-in-code "Direct link to And now, in code.")
...
![](/blog/assets/loading-screen-06.gif)
...
## But wait, mine doesn’t work\![​](#but-wait-mine-doesnt-work "Direct link to But wait, mine doesn’t work!")
...
![](/blog/assets/loading-screen-07.png)

## More Reading / Extra Credit[​](#more-reading--extra-credit "Direct link to More Reading / Extra Credit")
