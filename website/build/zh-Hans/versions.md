...
[![](/zh-Hans/img/header_logo.svg)![](/zh-Hans/img/header_logo.svg)](/zh-Hans/.md)

[**React Native**](/zh-Hans/.md)

[Development](#)

* [Guides](/zh-Hans/docs/getting-started.md)
* [Components](/zh-Hans/docs/components-and-apis.md)
* [APIs](/zh-Hans/docs/accessibilityinfo.md)
* [Architecture](/zh-Hans/architecture/overview.md)

[Contributing](/zh-Hans/contributing/overview.md)[Community](/zh-Hans/community/overview.md)[Showcase](/zh-Hans/showcase.md)[Blog](/zh-Hans/blog.md)[](https://github.com/facebook/react-native)

Search

# React Native versions

Open source React Native releases follow a release train that is coordinated on GitHub through the<!-- --> [`react-native-releases`](https://github.com/reactwg/react-native-releases/discussions) <!-- -->repository. New releases are created off the `main` branch of<!-- --> [`facebook/react-native`](https://github.com/facebook/react-native). They will follow a Release Candidate process to allow contributors like yourself to<!-- --> [verify the changes](/zh-Hans/docs/upgrading.md) and to identify any issues by<!-- --> [writing clear, actionable bug reports](https://github.com/facebook/react-native/issues). Eventually, the release candidate will be promoted to stable.
...
You can read more details about release schedule and the meaning of statuses on the [Releases Overview](/releases) page.

## Next version (Unreleased)

| main | [Documentation](/zh-Hans/docs/next/getting-started) | [Commits since 0.84](https://github.com/facebook/react-native/compare/0.84-stable...main) |
| ---- | --------------------------------------------------- | ----------------------------------------------------------------------------------------- |
...
| 0.84 | [Documentation](/zh-Hans/docs/getting-started.md) | [Changelog](https://github.com/facebook/react-native/releases/tag/v0.84.0) |
| ---- | ------------------------------------------------- | -------------------------------------------------------------------------- |

## Previous versions

| 0.83 | [Documentation](/zh-Hans/docs/0.83/getting-started) | [Changelog](https://github.com/facebook/react-native/releases/tag/v0.83.0) |
| ---- | --------------------------------------------------- | -------------------------------------------------------------------------- |
| 0.82 | [Documentation](/zh-Hans/docs/0.82/getting-started) | [Changelog](https://github.com/facebook/react-native/releases/tag/v0.82.0) |
| 0.81 | [Documentation](/zh-Hans/docs/0.81/getting-started) | [Changelog](https://github.com/facebook/react-native/releases/tag/v0.81.0) |
| 0.80 | [Documentation](/zh-Hans/docs/0.80/getting-started) | [Changelog](https://github.com/facebook/react-native/releases/tag/v0.80.0) |
| 0.79 | [Documentation](/zh-Hans/docs/0.79/getting-started) | [Changelog](https://github.com/facebook/react-native/releases/tag/v0.79.0) |
| 0.78 | [Documentation](/zh-Hans/docs/0.78/getting-started) | [Changelog](https://github.com/facebook/react-native/releases/tag/v0.78.0) |
| 0.77 | [Documentation](/zh-Hans/docs/0.77/getting-started) | [Changelog](https://github.com/facebook/react-native/releases/tag/v0.77.0) |
...
* [Showcase](/zh-Hans/showcase.md)
* [Contributing](/zh-Hans/contributing/overview.md)
* [Community](/zh-Hans/community/overview.md)
* [Directory](https://reactnative.directory/)
* [Stack Overflow](https://stackoverflow.com/questions/tagged/react-native)

Find us

* [Blog](/zh-Hans/blog.md)
...
[![Meta Open Source Logo](/zh-Hans/img/oss_logo.svg)![Meta Open Source Logo](/zh-Hans/img/oss_logo.svg)](https://opensource.fb.com/)
