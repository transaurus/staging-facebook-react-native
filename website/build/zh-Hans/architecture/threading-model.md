...
#### The React Native renderer distributes the work of the [render pipeline](/zh-Hans/architecture/render-pipeline.md) across multiple threads.[​](#the-react-native-renderer-distributes-the-work-of-the-render-pipeline-across-multiple-threads "Direct link to the-react-native-renderer-distributes-the-work-of-the-render-pipeline-across-multiple-threads")
...
Update originating on UI thread and skips rendering phase. See [React Native Renderer State Updates](/zh-Hans/architecture/render-pipeline.md#react-native-renderer-state-updates) for more details.
