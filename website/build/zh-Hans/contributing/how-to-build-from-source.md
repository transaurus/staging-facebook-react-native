...
To build from source, you need to have the Android SDK installed. If you followed the [Setting up the development environment](/zh-Hans/docs/environment-setup.md) guide, you should already be set up.
