...
You will need a few tools and dependencies in order to build and develop for React Native. These are covered as part of the [Environment Setup](/zh-Hans/docs/environment-setup.md) guide under the "Building Projects with Native Code" section.
...
Make sure your changes are correct and do not introduce any test failures. You can learn more in [Running and Writing Tests](/zh-Hans/contributing/how-to-run-and-write-tests.md).
...
To learn more about coding conventions, refer to the [Coding Style guide](/zh-Hans/contributing/how-to-contribute-code.md#coding-style).
...
* **[Changelog](/zh-Hans/contributing/changelogs-in-pull-requests.md):** Help release maintainers write release notes by providing a short description of what will be changed should the pull request get merged.
